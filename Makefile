#############################################################################
# Makefile for building: peoplescurrency-qt
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Jul 14 22:26:15 2014
# Project:  bitcoin-qt.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile bitcoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -D_FILE_OFFSET_BITS=64 -DQT_NO_DEBUG -DQT_SQL_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtSql -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/nick/Desktop/peoplescurrency/src/leveldb/libleveldb.a /home/nick/Desktop/peoplescurrency/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQtSql -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = src/qt/bitcoin.cpp \
		...
		src/haval.c \
		src/sha2big.c \
		src/checkpointsync.cpp build/moc_bitcoingui.cpp \
		...
		build/moc_torrentpage.cpp \
		build/moc_torrenttablemodel.cpp \
		qrc_bitcoin.cpp
OBJECTS       = build/bitcoin.o \
		...
		build/moc_torrentpage.o \
		build/moc_torrenttablemodel.o \
		build/qrc_bitcoin.o
DIST          = /usr/share/qt4/mkspecs/common/unix.conf \
		...
		bitcoin-qt.pro
QMAKE_TARGET  = peoplescurrency-qt
DESTDIR       = 
...
$(TARGET): /home/nick/Desktop/peoplescurrency/src/leveldb/libleveldb.a /home/nick/Desktop/peoplescurrency/build/build.h build/ui_sendcoinsdialog.h build/ui_coincontroldialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_blockbrowser.h build/ui_torrentpage.h build/ui_optionsdialog.h $(OBJECTS)  
...
dist: 
	@$(CHK_DIR_EXISTS) build/peoplescurrency-qt0.9.0.0 || $(MKDIR) build/peoplescurrency-qt0.9.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/peoplescurrency-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/peoplescurrency-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/coincontrol.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/blockbrowser.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/macnotificationhandler.h src/qt/splashscreen.h src/qt/torrentpage.h src/qt/torrenttablemodel.h src/hashblock.h src/sph_blake.h src/sph_skein.h src/sph_keccak.h src/sph_jh.h src/sph_groestl.h src/sph_bmw.h src/sph_types.h src/sph_luffa.h src/sph_cubehash.h src/sph_echo.h src/sph_shavite.h src/sph_simd.h src/sph_hamsi.h src/sph_fugue.h src/sph_shabal.h src/sph_whirlpool.h src/sph_haval.h src/sph_sha2.h build/peoplescurrency-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/peoplescurrency-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcdarksend.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/blockbrowser.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/qt/torrentpage.cpp src/qt/torrenttablemodel.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/blake.c src/bmw.c src/groestl.c src/jh.c src/keccak.c src/skein.c src/luffa.c src/cubehash.c src/shavite.c src/echo.c src/simd.c src/hamsi.c src/fugue.c src/shabal.c src/whirlpool.c src/haval.c src/sha2big.c src/checkpointsync.cpp build/peoplescurrency-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/coincontroldialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/blockbrowser.ui src/qt/forms/torrentpage.ui src/qt/forms/optionsdialog.ui build/peoplescurrency-qt0.9.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/peoplescurrency-qt0.9.0.0/ && (cd `dirname build/peoplescurrency-qt0.9.0.0` && $(TAR) peoplescurrency-qt0.9.0.0.tar peoplescurrency-qt0.9.0.0 && $(COMPRESS) peoplescurrency-qt0.9.0.0.tar) && $(MOVE) `dirname build/peoplescurrency-qt0.9.0.0`/peoplescurrency-qt0.9.0.0.tar.gz . && $(DEL_FILE) -r build/peoplescurrency-qt0.9.0.0


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/nick/Desktop/peoplescurrency/src/leveldb/libleveldb.a; cd /home/nick/Desktop/peoplescurrency/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/nick/Desktop/peoplescurrency/src/leveldb/libleveldb.a: FORCE
	cd /home/nick/Desktop/peoplescurrency/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/nick/Desktop/peoplescurrency/build/build.h: FORCE
	cd /home/nick/Desktop/peoplescurrency; /bin/sh share/genbuild.sh /home/nick/Desktop/peoplescurrency/build/build.h
...
build/moc_torrentpage.cpp: src/qt/torrentpage.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/torrentpage.h -o build/moc_torrentpage.cpp

build/moc_torrenttablemodel.cpp: src/qt/torrenttablemodel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/torrenttablemodel.h -o build/moc_torrenttablemodel.cpp
...
compiler_moc_source_make_all: build/overviewpage.moc build/rpcconsole.moc build/torrentpage.moc
compiler_moc_source_clean:
	-$(DEL_FILE) build/overviewpage.moc build/rpcconsole.moc build/torrentpage.moc
...
build/torrentpage.moc: src/qt/torrentpage.h \
		build/ui_torrentpage.h \
		src/qt/clientmodel.h \
		...
		src/ui_interface.h \
		src/qt/torrentpage.cpp
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) src/qt/torrentpage.cpp -o build/torrentpage.moc
...
build/ui_torrentpage.h: src/qt/forms/torrentpage.ui
	/usr/bin/uic-qt4 src/qt/forms/torrentpage.ui -o build/ui_torrentpage.h
...
build/main.o: src/main.cpp src/alert.h \
		...
		src/leveldb.h \
		src/leveldb/db.h \
		src/leveldb/iterator.h \
		src/leveldb/slice.h \
		src/leveldb/status.h \
		src/leveldb/options.h \
		src/leveldb/write_batch.h \
		src/init.h \
		src/wallet.h \
		src/ui_interface.h \
		src/walletdb.h \
...
build/torrentpage.o: src/qt/torrentpage.cpp src/qt/torrentpage.h \
		build/ui_torrentpage.h \
		src/qt/clientmodel.h \
		src/qt/torrenttablemodel.h \
		src/qt/bitcoingui.h \
		...
		src/json/json_spirit_utils.h \
		src/ui_interface.h \
		build/torrentpage.moc
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/torrentpage.o src/qt/torrentpage.cpp

build/torrenttablemodel.o: src/qt/torrenttablemodel.cpp src/qt/torrenttablemodel.h \
		src/qt/guiutil.h \
		src/bitcoinrpc.h \
		src/json/json_spirit_reader_template.h \
		src/json/json_spirit_value.h \
		...
		src/qt/walletmodel.h \
		src/ui_interface.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/torrenttablemodel.o src/qt/torrenttablemodel.cpp
...
build/haval.o: src/haval.c src/sph_haval.h \
		src/sph_types.h \
		src/haval_helper.c
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/haval.o src/haval.c

build/sha2big.o: src/sha2big.c src/sph_sha2.h \
		src/sph_types.h \
		src/md_helper.c
...
build/moc_torrentpage.o: build/moc_torrentpage.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_torrentpage.o build/moc_torrentpage.cpp

build/moc_torrenttablemodel.o: build/moc_torrenttablemodel.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_torrenttablemodel.o build/moc_torrenttablemodel.cpp
